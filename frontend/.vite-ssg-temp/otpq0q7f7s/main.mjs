...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_router_link = resolveComponent("router-link");
  _push(`<!--[--><div class="top-bar" data-v-875dad83><div class="container top-bar-inner" data-v-875dad83><div class="top-right-login" data-v-875dad83>`);
  if (!$data.userData) {
    _push(ssrRenderComponent(_component_router_link, {
      to: "/login",
      class: "btn-login-top"
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="fi fi-br-user" data-v-875dad83${_scopeId}></i><span data-v-875dad83${_scopeId}>Đăng nhập</span>`);
        } else {
          return [
            createVNode("i", { class: "fi fi-br-user" }),
            createVNode("span", null, "Đăng nhập")
    ...
    _push(`<div class="user-pill" data-v-875dad83><i class="fi fi-br-user" data-v-875dad83></i><span data-v-875dad83>${ssrInterpolate($data.userData.name || $data.userData.username)}</span><i class="fi fi-br-angle-down small-icon" data-v-875dad83></i></div>`);
  }
  if ($data.showUserMenu) {
    _push(`<div class="home-user-menu" data-v-875dad83><div class="home-user-menu-item" data-v-875dad83><i class="fi fi-br-user" data-v-875dad83></i><span data-v-875dad83>${ssrInterpolate($data.userData.name || $data.userData.username)}</span></div>`);
    _push(ssrRenderComponent(_component_router_link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="fi fi-br-file-invoice" data-v-875dad83${_scopeId}></i><span data-v-875dad83${_scopeId}>Báo giá của tôi</span>`);
        } else {
          return [
            createVNode("i", { class: "fi fi-br-file-invoice" }),
    ...
    _push(ssrRenderComponent(_component_router_link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="fi fi-br-settings" data-v-875dad83${_scopeId}></i><span data-v-875dad83${_scopeId}>Tài khoản</span>`);
        } else {
          return [
    ...
    _push(`<button class="home-user-menu-item logout-btn" data-v-875dad83><i class="fi fi-br-sign-out" data-v-875dad83></i><span data-v-875dad83>Đăng xuất</span></button></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div></div></div><div class="home" data-v-875dad83><section class="hero" data-v-875dad83><div class="container hero-grid" data-v-875dad83><div class="hero-content" data-v-875dad83><div class="hero-head" data-v-875dad83><div class="logo-block" data-v-875dad83><div class="logo-wrapper" data-v-875dad83><img${ssrRenderAttr("src", _imports_0)} alt="Logo Vietceramics" class="logo" data-v-875dad83></div><div class="logo-text" data-v-875dad83><span class="eyebrow-pill logo-sub" data-v-875dad83>item</span></div></div></div><h1 class="hero-title" data-v-875dad83> Khơi cảm hứng cho mọi không gian </h1><p class="hero-lead" data-v-875dad83> Tìm nhanh mã sản phẩm, bộ sưu tập và lọc theo nhu cầu thiết kế. </p><div class="search-box position-relative" data-v-875dad83><div class="search-input-wrapper" data-v-875dad83><i class="fi fi-br-search search-icon" data-v-875dad83></i><input type="text" class="form-control search-input" placeholder="Nhập mã sản phẩm..."${ssrRenderAttr("value", $data.searchQuery)} data-v-875dad83></div>`);
  if ($data.showResults || $data.isSearching) {
    _push(`<div class="search-results" data-v-875dad83>`);
    if ($data.isSearching) {
      _push(`<div class="search-loading" data-v-875dad83><div class="spinner" data-v-875dad83></div><span data-v-875dad83>Đang tìm kiếm...</span></div>`);
    } else if ($data.searchResults.length === 0) {
      _push(`<div class="no-results" data-v-875dad83> Không tìm thấy kết quả </div>`);
    } else {
      _push(`<div class="search-items" data-v-875dad83><!--[-->`);
      ssrRenderList($data.searchResults, (item) => {
        _push(`<div class="search-item" role="button" tabindex="0" data-v-875dad83><div class="d-flex align-items-center" data-v-875dad83><div class="search-thumb-wrapper" data-v-875dad83><img${ssrRenderAttr("src", item.thumbnail)} class="search-thumb"${ssrRenderAttr("alt", item.name)} data-v-875dad83></div><div class="search-item-content" data-v-875dad83><span class="product-name" data-v-875dad83>${ssrInterpolate(item.product_name)}</span><div class="collection-name" data-v-875dad83>`);
        _push(ssrRenderComponent(_component_router_link, {
        ...
        _push(`</div></div><div class="search-item-icon" data-v-875dad83><i class="fi fi-br-angle-right" data-v-875dad83></i></div></div></div>`);
      });
      _push(`<!--]--></div>`);
    }
    _push(`</div>`);
  ...
  _push(`</div><div class="hero-showcase" data-v-875dad83><!--[-->`);
  ssrRenderList($data.spaces, (space) => {
    _push(`<div class="spotlight-card" style="${ssrRenderStyle({ background: space.gradient })}" data-v-875dad83><div class="spotlight-icon" data-v-875dad83><img${ssrRenderAttr("src", space.image)}${ssrRenderAttr("alt", space.name)} class="space-image" data-v-875dad83></div><div class="spotlight-body" data-v-875dad83><p class="spotlight-eyebrow" data-v-875dad83>Danh mục</p><h3 data-v-875dad83>${ssrInterpolate(space.name)}</h3><p class="spotlight-text" data-v-875dad83>${ssrInterpolate(space.description)}</p></div>`);
    _push(ssrRenderComponent(_component_router_link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(` Khám phá <i class="fi fi-br-arrow-right" data-v-875dad83${_scopeId}></i>`);
        } else {
          return [
  ...
  _push(`<!--]--></div></div></div></section><section class="section sizes-section" data-v-875dad83><div class="container" data-v-875dad83><div class="section-header" data-v-875dad83><div data-v-875dad83><p class="eyebrow" data-v-875dad83>Lọc theo kích thước</p><h2 data-v-875dad83>Kích thước phổ biến</h2><p class="muted" data-v-875dad83>Danh sách lấy trực tiếp từ bộ lọc danh mục.</p></div>`);
  _push(ssrRenderComponent(_component_router_link, {
    class: "section-link",
    to: { name: "catalog" }
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Mở bộ lọc <i class="fi fi-br-arrow-right" data-v-875dad83${_scopeId}></i>`);
      } else {
        return [
  ...
  _push(`</div><div class="chip-rail" data-v-875dad83><!--[-->`);
  ...
  _push(`<!--]--></div></div></section><section class="section sanitary-section" data-v-875dad83><div class="container" data-v-875dad83><div class="section-header" data-v-875dad83><div data-v-875dad83><p class="eyebrow" data-v-875dad83>Thiết bị vệ sinh</p><h2 data-v-875dad83>Danh mục nổi bật</h2><p class="muted" data-v-875dad83>Chọn nhanh các nhóm sản phẩm được quan tâm nhiều.</p></div>`);
  _push(ssrRenderComponent(_component_router_link, {
    class: "section-link",
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Xem tất cả TBVS <i class="fi fi-br-arrow-right" data-v-875dad83${_scopeId}></i>`);
      } else {
        return [
  ...
  _push(`</div><div class="pill-grid" data-v-875dad83><!--[-->`);
  ssrRenderList($options.sanitaryHighlights, (category) => {
    _push(ssrRenderComponent(_component_router_link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<span class="pill-dot" data-v-875dad83${_scopeId}></span><span class="pill-text" data-v-875dad83${_scopeId}>${ssrInterpolate(category.name)}</span><i class="fi fi-br-arrow-right" data-v-875dad83${_scopeId}></i>`);
        } else {
          return [
...
const HomeView = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-875dad83"]]);
const _sfc_main = {
  name: "QuoteList",
  components: {
    QrcodeVue
